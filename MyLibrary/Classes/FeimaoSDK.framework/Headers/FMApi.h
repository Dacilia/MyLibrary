 ...
 * @param resp resp
 */
- (void)onResp:(FMBaseResp*_Nullable)resp;
 ...
 */
+(void)sendReq:(FMBaseReq*_Nullable)req;
 ...
 */
+(BOOL)handleOpenURL:(NSURL *_Nullable)url  delegate:(nullable id<FMApiDelegate>)delegate;
@end
